...
O Gauntlet não é um swarm nem um DAG. É um loop adversarial baseado em papéis, e existe por causa de uma observação, guardada no arquivo da skill: _"Um agente sozinho produz um resultado decente e para. Ele para porque ele mesmo é quem julga."_ E conhece toda a razão por trás de cada decisão que tomou, o que o torna excelente em explicar por que o próprio trabalho é aceitável.
...
Tudo isso descansa em três regras que valem mais que qualquer guia de estilo: **a régua não é negociável**; **quem constrói nunca dá a nota**; **o loop nunca termina a si mesmo**. E a frase que resume, direto do arquivo da skill: _"O que faz a diferença não é o número de agentes, é que cada afirmação carregue um número e um arquivo:linha."_
...
_Se você está rodando loops adversariais nos seus próprios projetos, ou acha que nota de 0 a 10 de um language model é astrologia com etapas extras, minha inbox está aberta._
