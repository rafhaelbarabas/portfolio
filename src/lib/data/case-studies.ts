export interface OutcomeCaseStudy {
  ...
  meta: {
    ...
    pt: Array<{ label: string; value: string }>;
  };
  stats: {
    en: Array<{ value: string; label: string; sub: string }>;
    pt: Array<{ value: string; label: string; sub: string }>;
  };
...
export const outcomeCaseStudies: OutcomeCaseStudy[] = [
  {
    ...
    index: "03",
    title: {
      en: "Ralph Starter · Case study",
      pt: "Ralph Starter · Estudo de caso",
    },
    description: {
    ...
    overline: {
      en: "Case study — agent orchestration",
      pt: "Estudo de caso — orquestração de agents",
    },
    heading: {
      en: "A delivery harness, not another chat window.",
      pt: "Um harness de entrega, não outra janela de chat.",
    },
    lede: {
    ...
    meta: {
      en: [
        { label: "Role", value: "Creator / AI engineering" },
        { label: "Period", value: "2026 — present" },
        { label: "Surface", value: "CLI + MCP" },
        { label: "Status", value: "Production" },
      ],
      pt: [
        { label: "Papel", value: "Criador / AI engineering" },
        { label: "Período", value: "2026 — presente" },
        { label: "Superfície", value: "CLI + MCP" },
        { label: "Status", value: "Produção" },
      ],
    },
    stats: {
      en: [
        { value: "100+", label: "Daily downloads", sub: "Public npm adoption" },
        {
          value: "3",
          label: "Swarm modes",
          sub: "Race · consensus · pipeline",
        },
        {
          value: "4",
          label: "Integrations",
          sub: "Figma · GitHub · Linear · Notion",
        },
        {
          value: "1",
          label: "Delivery contract",
          sub: "Spec → isolated work → verified merge",
        },
      ],
      pt: [
        {
          ...
          sub: "Adoção pública no npm",
        },
        {
          value: "3",
          label: "Modos de swarm",
          sub: "Race · consensus · pipeline",
        },
        {
          value: "4",
        ...
        {
          value: "1",
          label: "Contrato de entrega",
          sub: "Spec → trabalho isolado → merge verificado",
        },
      ],
    },
    challenge: {
  ...
  },
  {
    ...
    index: "04",
    title: {
      en: "AEO.js + AEO Checker · Case study",
      pt: "AEO.js + AEO Checker · Estudo de caso",
    },
    description: {
    ...
    overline: {
      en: "Case study — answer engine optimization",
      pt: "Estudo de caso — answer engine optimization",
    },
    heading: {
      en: "AEO as a delivery system, not a checklist.",
      pt: "AEO como sistema de entrega, não checklist.",
    },
    lede: {
    ...
    meta: {
      en: [
        { label: "Role", value: "Creator / fullstack" },
        { label: "Period", value: "2026 — present" },
        { label: "Products", value: "Framework + scanner" },
        { label: "Status", value: "Production" },
      ],
      pt: [
        { label: "Papel", value: "Criador / fullstack" },
        { label: "Período", value: "2026 — presente" },
        { label: "Produtos", value: "Framework + scanner" },
        { label: "Status", value: "Produção" },
      ],
    },
    stats: {
      en: [
        {
          ...
          sub: "Implementation framework + diagnostic scanner",
        },
        {
          value: "EN/PT",
          label: "Publishing model",
          sub: "Canonical localized routes and hreflang",
        },
        {
          value: "JSON-LD",
          label: "Entity layer",
          sub: "Structured claims tied to visible content",
        },
        {
          value: "CI",
          label: "Verification",
          sub: "Discovery artifacts checked at build time",
        },
      ],
      pt: [
        {
          value: "2",
          label: "Superfícies",
          sub: "Framework de implementação + scanner diagnóstico",
        },
        {
          value: "EN/PT",
          label: "Publicação",
          sub: "Rotas localizadas canônicas e hreflang",
        },
        {
          value: "JSON-LD",
          label: "Camada de entidades",
          sub: "Claims estruturados ligados ao conteúdo visível",
        },
        {
          value: "CI",
          label: "Verificação",
          sub: "Artefatos de descoberta validados no build",
        },
      ],
    },
    challenge: {
  ...
  },
  {
    ...
    overline: {
      en: "Case study — browser game",
      pt: "Estudo de caso — jogo de navegador",
    },
    heading: {
      en: "A playable product built through an AI harness.",
      pt: "Um produto jogável construído por um harness de IA.",
    },
    lede: {
    ...
    meta: {
      en: [
        ...
        { label: "Stack", value: "Three.js + Supabase" },
        { label: "Stage", value: "Public alpha" },
      ],
      pt: [
        { label: "Papel", value: "Criador / fullstack" },
        { label: "Período", value: "2026" },
        { label: "Stack", value: "Three.js + Supabase" },
        { label: "Estágio", value: "Alpha público" },
      ],
    },
    stats: {
      en: [
        { value: "2,191", label: "Players", sub: "Public alpha" },
        { value: "154K+", label: "Kills", sub: "Measured gameplay events" },
        { value: "27", label: "Countries", sub: "Players reached" },
        { value: "WebGL", label: "Runtime", sub: "No install required" },
      ],
      pt: [
        { value: "2.191", label: "Jogadores", sub: "Alpha público" },
        { value: "154K+", label: "Kills", sub: "Eventos reais de gameplay" },
        { value: "27", label: "Países", sub: "Alcance dos jogadores" },
        { value: "WebGL", label: "Runtime", sub: "Sem instalação" },
      ],
    },
    challenge: {
