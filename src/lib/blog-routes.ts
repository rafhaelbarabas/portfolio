...
export const PT_BLOG_SLUGS: Record<string, string> = {
  ...
  "agent-command-center":
    "centro-de-comando-para-swarms-de-agentes-em-markdown",
  "agents-welcome-portfolio": "este-portfolio-e-agent-first",
  "automating-entire-workflows-with-ralph-starter":
    "automatizando-fluxos-de-trabalho-com-ralph-starter",
  "autoresearcher-pareto-frontier":
    "mantendo-um-agente-de-pesquisa-autonomo-honesto",
  ...
  "from-prompt-to-product-five-ways-to-build-with-ai":
    "do-prompt-ao-produto-cinco-formas-de-desenvolver-com-ia",
  ...
  "getting-started-with-next-js-strapi-security-first":
    "comecando-com-next-js-e-strapi-seguranca-em-primeiro-lugar",
  "how-i-hit-1-qec-using-ai":
    "como-cheguei-ao-primeiro-lugar-em-correcao-de-erros-quanticos-com-ia",
  "i-built-my-portfolio-with-a-fleet-of-ai-agents":
    "como-construi-este-portfolio-com-agentes-de-ia",
  "inside-the-gauntlet-loop": "por-dentro-do-gauntlet-loop",
  "llm-cross-pollination":
    "polinizacao-cruzada-de-llms-revisao-por-pares-para-maquinas",
  "mastra-field-notes": "reescrevi-meu-loop-de-agente-em-mastra",
  "mini-shai-hulud-dependency-risk":
    "mini-shai-hulud-e-o-risco-real-das-dependencias",
  "openrouter-routing":
    "roteando-papeis-de-agente-entre-providers-com-openrouter",
  ...
  "the-agent-swarm-that-took-1-on-ecdsa-fail":
    "o-swarm-que-chegou-ao-primeiro-lugar-no-ecdsa-fail",
  "vercel-ai-sdk-streaming":
    "streaming-de-2-85-milhoes-de-mensagens-com-vercel-ai-sdk",
...
export const getBlogSlug = (locale: "en" | "pt", translationKey: string) =>
  locale === "pt"
    ? (PT_BLOG_SLUGS[translationKey] ?? translationKey)
    : translationKey;
...
export const getBlogPathsFromPathname = (pathname: string) => {
  ...
  const translationKey = isPt
    ? (EN_BY_PT_SLUG.get(visibleSlug) ?? visibleSlug)
    : visibleSlug;
